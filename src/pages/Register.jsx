            ...
            <div className="content-center w-full bg-cyan-600 sm:w-full p-10">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4 px-20">
                        <label className="block text-white text-lg font-semibold mb-2" htmlFor="nama_lengkap">
                            Nama Pengguna
                        </label>
                        <input
                    ...
                    <div className="mb-4 px-20">
                        <label className="block text-white text-lg font-semibold mb-2" htmlFor="password">
                            Kata Sandi
                        </label>
                        <input
                            className="shadow appearance-none border rounded w-full py-3 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline text-sm"
                    ...
                    <div className="mb-4 px-20">
                        <label className="block text-white text-lg font-semibold mb-2" htmlFor="jenis_kelamin">
                            Jenis Kelamin
                        </label>
                        <select
                    ...
                    <div className="px-20">
                        <Button type="submit" variant="bg-teal-500 text-2xl">Daftar</Button>
                    </div>
