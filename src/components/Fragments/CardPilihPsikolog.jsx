const CardPilihPsikolog = () => {
  return (
    <>
    <div className="flex justify-start items-center gap-4 border-2 border-teal-500 p-5 rounded-lg">
          <img
          ...
          <div className="w-full">
            ...
            <div className="flex justify-between gap-4 w-full items-center">
              <div className="flex justify-start gap-4">
                {" "}
                <div className="text-white py-1 px-4 bg-teal-500 rounded-md">
                  Chat
                </div>
                <div className="text-white py-1 px-4 bg-teal-500 rounded-md">
                  Lihat Profil
        ...
        <div className="bg-teal-500 p-8 max-w-4xl mx-auto rounded-lg shadow-md text-white">
