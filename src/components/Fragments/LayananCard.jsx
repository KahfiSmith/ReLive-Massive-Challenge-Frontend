...
export const ServiceCards = () => (
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3 lg:gap-10">
        <ServiceCard
            icon={<AudioLines data-lucide="audio-lines" className="text-3xl bg-[#BCF0DA] p-2 rounded-md text-[#0E9F6E]" />}
        ...
        />
        <ServiceCard
            icon={<HandHeart data-lucide="hand-heart" className="text-3xl bg-[#FCD9BD] p-2 rounded-md text-[#FF5A1F]" />}
        ...
        />
        <ServiceCard
            icon={<FolderLock data-lucide="folder-lock" className="text-3xl bg-[#C3DDFD] p-2 rounded-md text-[#3F83F8]" />}
