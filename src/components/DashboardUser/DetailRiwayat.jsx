...
const DetailRiwayat = ({ open }) => {
    return (
        <div className="flex-grow" style={{marginLeft: open ? "240px" : "80px", transition: "margin-left 500ms ease-in-out",}}>
            <div className="fixed w-full h-96 overflow-hidden">
                <div className="w-full h-1/6 bg-teal-200 text-black font-semibold text-center content-center">
                    <p>Detail Riwayat</p>
                </div>
            </div>
            <div className="container mx-auto py-24 px-20">
                <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    ...
                    <div className="bg-gray-200 p-4 rounded-lg col-span-3">
                        ...
                        <p className="text-gray-500">Saudara Yosia masih mengalami halusinasi, gangguan konsentrasi, dan mulai tidak bisa membedakan dunia nyata dan imajinasinya sendiri.</p>
                    </div>
                    <div className="text-center pt-10 rounded-lg col-span-3 text-gray-500 font-semibold">
                        <p>Sdr Yosia terduga skizofrenia berat. Gejala sudah di fase gejala yang berat, <span className="text-teal-500">membutuhkan</span> obat, <span className="text-teal-500">membutuhkan</span> rujukan ke psikiater.</p>
                    </div>
