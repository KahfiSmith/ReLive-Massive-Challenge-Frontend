const Konsultasi = () => {
    return (
        <div id="konsultasi" className="pt-10 mb-12 flex justify-center text-slate-600">
            ...
            <div className="flex flex-wrap">
                <div className="w-full self-center px-8 md:px-12 lg:px-20 lg:w-1/2">
                    ...
                    <a href="#"
                        className="text-base font-semibold py-3 px-8 bg-teal-500 rounded-md hover:bg-teal-400 trasition duration-300 ease-in-out lg:text-xl text-white">Konsultasi
                        Sekarang
                    </a>
                </div>
                <div className="w-full self-end px-4 lg:w-1/2">
                    <div className="mt-10 relative">
                        <img src="/images/main3.png" alt="" className="max-w-full mx-auto" />
                    </div>
                </div>
            </div>
        </div>
