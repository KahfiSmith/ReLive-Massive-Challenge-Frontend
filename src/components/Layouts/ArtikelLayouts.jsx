  ...
  return (
    <div id="artikel">
      <div className="relative w-full max-h-full text-slate-600 mb-[42rem]">
        <div
          className="relative w-full h-[30rem] bg-cover bg-center p-16"
          style={{ backgroundImage: "url('/images/tidur.jpg')" }}
        >
        ...
        <div className="container px-8 flex justify-end w-full h-auto text-slate-600">
          <div className="w-fit h-auto mr-20 my-10 bg-white">
            ...
            <div className="bg-white w-[400px] border-b-2 p-4 shadow flex items-center">
              <img
            ...
            <div className="bg-white w-[400px] border-b-2 p-4 mb-5  shadow flex items-center">
              <img
                src="https://via.placeholder.com/48"
                alt=""
                className="w-16 h-16"
